              ...
              <form className="box-form">
                ...
                <div className="box-form__car-type">
                  ...
                  <select value={pickUp} onChange={handlePick}>
                    ...
                    <option>SeaTac Airport | Lot-1</option>
                    <option>Capitol Hill</option>
                    <option>Tacoma Armory</option>
                    <option>Redmond Shopping Center</option>
                    <option>Kirkland | Heathman Hotel</option>
                  </select>
                </div>
      ...
      <div className={`booking-modal ${modal ? "active-modal" : ""}`}>
        ...
        <div className="booking-modal__message">
          <h4>
            ...
            you will receive your booking confirmation code:
          </h4>
          <p>
            Please save the confirmation note, and present it to our AJ Auto
            Representative at location of choice.
          </p>
        </div>
        {/* car info */}
        ...
        <div className="booking-modal__person-info">
          ...
          <form className="info-form">
            ...
            <span className="info-form__checkbox">
              ...
              <p>
                Please sign me up for AJ Auto Rentals Newsletter for latest
                news, offers, discount codes, and more!
              </p>
            </span>
